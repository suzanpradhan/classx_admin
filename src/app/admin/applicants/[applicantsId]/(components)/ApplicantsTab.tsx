            ...
            >
                <div>
                    <div className="grid grid-cols-2 md:grid-cols-none md:mt-2 ">
                        ...
                        <div className="text-base capitalize text-black">{Applicants.full_name}</div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-none">
                    ...
                    <div className="text-base text-black">{Applicants.current_address}</div>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-none">
                ...
                <div className="grid grid-cols-2 md:grid-cols-none">
                    ...
                    <div className="text-base text-black">{Applicants.applicant_type}</div>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-none">
