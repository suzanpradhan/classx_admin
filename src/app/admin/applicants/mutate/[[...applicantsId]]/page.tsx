...
import { applicantsSchema, ApplicantsSchemaType, ApplicantsType } from '@/modules/applicants/applicantsType';
                ...
                <div className="flex gap-2 mb-2 max-sm:flex-col">
                    <div className="flex flex-col flex-1">
                        ...
                        {formik.errors.perm_address && (
                            <div className="text-red-500 text-sm">{formik.errors.perm_address}</div>
                        )}
                    </div>
                    ...
                    <div className="flex flex-col flex-1">
                        ...
                        {formik.errors.current_address && (
                            <div className="text-red-500 text-sm">{formik.errors.current_address}</div>
                        )}
                    </div>
                </div>
                <div className="flex gap-2 mb-2 max-sm:flex-col">
                ...
                <div className="flex gap-2 mb-2 max-sm:flex-col">
                    <div className="flex flex-col flex-1">
                        ...
                        {formik.errors.prev_work_link && (
                            <div className="text-red-500 text-sm">{formik.errors.prev_work_link}</div>
                        )}
                    </div>
                    <div className="flex flex-col flex-1">
                        <ImageInput
                        ...
                        {formik.errors.document && (
                            <div className="text-red-500 text-sm">{formik.errors.document}</div>
                        )}
                    </div>
